				...
				<div className="post-div dark:bg-darkDiv ">
					<div className="post-padding">
						<div className="post-profile-div">
							...
							<input
								type="text"
								className="post-input dark:bg-darkInput dark:text-darkIcon"
						...
						<div className="post-icon-container">
							<label htmlFor="photo" onClick={Wrapp} style={{ cursor: 'pointer' }}>
								<div className="post-icon-div">
									...
									<div className="post-icon-text dark:text-darkIcon">Photo/Video</div>
								</div>
								<input
									type="file"
									id="photo"
							...
							<label htmlFor="photo" onClick={Wrapp} style={{ cursor: 'pointer' }}>
								<div className="post-icon-div">
									<img
										...
										alt=""
									/>
									<div className="post-icon-text dark:text-darkIcon">Video</div>
								</div>
								<input
									type="file"
									id="photo"
							...
							<div className="post-icon-div" onClick={() => { Emoji(); ok(); }}>
								...
								<div className="post-icon-text dark:text-darkIcon">Emoji</div>
							</div>
						</div>
